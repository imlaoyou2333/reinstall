...
```bash
curl -O https://raw.githubusercontent.com/imlaoyou2333/reinstall/main/reinstall.sh || wget -O ${_##*/} $_
```

国内服务器：

```bash
curl -O https://ghfast.top/https://raw.githubusercontent.com/imlaoyou2333/reinstall/main/reinstall.sh || wget -O ${_##*/} $_
```
